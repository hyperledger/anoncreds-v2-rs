...
use crate::vcp::{Error, UnexpectedError, VCPResult};
use crate::vcp::r#impl::ac2c::presentation_request_setup::attr_label_for_idx;
...
pub fn sign() -> Sign {
    Arc::new(|_rng_seed, vals, sd| {
        ...
        let (_s, sdcts)    = from_api(signer_public_data)?;
