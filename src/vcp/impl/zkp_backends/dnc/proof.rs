...
use crate::vcp::r#impl::common::general::presentation_request_setup::POK_OF_SIGNATURE_APPLIES_TO_ALL_ATTRIBUTES;
use crate::vcp::r#impl::common::to_from_api::*;
use crate::vcp::r#impl::common::util::*;
use crate::vcp::r#impl::zkp_backends::dnc::generate_frs::*;
use crate::vcp::r#impl::zkp_backends::dnc::reversible_encoding::*;
