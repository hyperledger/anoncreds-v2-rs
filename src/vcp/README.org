...
of type =CreateBlindSigningInfo= ([[./interfaces/primitives.rs][./interfaces/non_primitives.rs]])
with
- a =Natural= (an RNG seed)
- =SignerPublicData=
- a list of =CredAttrIndexAndDataValue= ([[./interfaces/types.rs][./interfaces/types.rs]])
...
of type =UnblindBlindedSignature= ([[./interfaces/primitives.rs][./interfaces/non_primitives.rs]])
