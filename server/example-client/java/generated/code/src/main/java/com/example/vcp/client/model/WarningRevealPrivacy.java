...
/**
 * WarningRevealPrivacy
 */
public class WarningRevealPrivacy {
  /**
   * Gets or Sets tag
   */
  ...
  public WarningRevealPrivacy() {
  }

  public WarningRevealPrivacy tag(@javax.annotation.Nonnull TagEnum tag) {
    this.tag = tag;
    return this;
  }
  ...
  public WarningRevealPrivacy contents(@javax.annotation.Nonnull List<String> contents) {
    this.contents = contents;
    return this;
  }

  public WarningRevealPrivacy addContentsItem(String contentsItem) {
  ...
  public void setContents(@javax.annotation.Nonnull List<String> contents) {
    this.contents = contents;
  }
  ...
  public boolean equals(Object o) {
    ...
    WarningRevealPrivacy warningOneOf1 = (WarningRevealPrivacy) o;
    return Objects.equals(this.tag, warningOneOf1.tag) &&
        Objects.equals(this.contents, warningOneOf1.contents);
  }
  ...
  public String toString() {
    ...
    sb.append("class WarningRevealPrivacy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WarningRevealPrivacy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WarningRevealPrivacy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WarningRevealPrivacy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WarningRevealPrivacy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WarningRevealPrivacy.class));

       return (TypeAdapter<T>) new TypeAdapter<WarningRevealPrivacy>() {
           @Override
           public void write(JsonWriter out, WarningRevealPrivacy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WarningRevealPrivacy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WarningRevealPrivacy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WarningRevealPrivacy
   * @throws IOException if the JSON string is invalid with respect to WarningRevealPrivacy
   */
  public static WarningRevealPrivacy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WarningRevealPrivacy.class);
  }

  /**
   * Convert an instance of WarningRevealPrivacy to an JSON string
   *
   * @return JSON string
   */
