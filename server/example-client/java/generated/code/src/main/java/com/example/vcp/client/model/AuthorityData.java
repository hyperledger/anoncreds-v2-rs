...
public class AuthorityData {
  public static final String SERIALIZED_NAME_AUTHORITY_PUBLIC_DATA = "authorityPublicData";
  @SerializedName(SERIALIZED_NAME_AUTHORITY_PUBLIC_DATA)
  @javax.annotation.Nonnull
  private String authorityPublicData;
  ...
  public AuthorityData authorityPublicData(@javax.annotation.Nonnull String authorityPublicData) {
    this.authorityPublicData = authorityPublicData;
    return this;
  }

  /**
   * An Authority&#39;s public key.
   * @return authorityPublicData
   */
  @javax.annotation.Nonnull
  public String getAuthorityPublicData() {
    return authorityPublicData;
  }

  public void setAuthorityPublicData(@javax.annotation.Nonnull String authorityPublicData) {
    this.authorityPublicData = authorityPublicData;
  }


  public AuthorityData authoritySecretData(@javax.annotation.Nonnull String authoritySecretData) {
  ...
  public AuthorityData authorityDecryptionKey(@javax.annotation.Nonnull String authorityDecryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorityData authorityData = (AuthorityData) o;
    return Objects.equals(this.authorityPublicData, authorityData.authorityPublicData) &&
        Objects.equals(this.authoritySecretData, authorityData.authoritySecretData) &&
        Objects.equals(this.authorityDecryptionKey, authorityData.authorityDecryptionKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorityPublicData, authoritySecretData, authorityDecryptionKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthorityData {\n");
    sb.append("    authorityPublicData: ").append(toIndentedString(authorityPublicData)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorityData
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorityData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorityData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorityData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorityData.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorityData>() {
           @Override
           public void write(JsonWriter out, AuthorityData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorityData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorityData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorityData
   * @throws IOException if the JSON string is invalid with respect to AuthorityData
   */
  public static AuthorityData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorityData.class);
  }

  /**
   * Convert an instance of AuthorityData to an JSON string
   *
   * @return JSON string
   */
