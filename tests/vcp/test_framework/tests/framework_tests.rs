...
macro_rules! testing_framework_test {
    ($crypto_interface: ident) => {
        mod testing_framework {
            ...
            use $crate::vcp::test_framework::tests::framework_tests::*;
...
#[macro_export]
macro_rules! pok_and_reveal_metadata_test_test {
    ($platform_api: expr) => {
...
#[macro_export]
macro_rules! pok_and_reveal_metadata_and_eqs_test {
    ($platform_api: expr) => {
...
#[macro_export]
macro_rules! pok_and_reveal_metadata_test_detailed_cond_test {
    ($platform_api: expr, $lib_spec: expr) => {
...
#[macro_export]
macro_rules! initial_test_via_new_framework_test {
    ($platform_api: expr, $lib_spec: expr) => {
