    ...
    Arc::new(move |ts| {
        ...
        cred_reqs.in_range.0.insert(
            ...
            api::InRangeInfo {
                ...
                range_proving_key_label: range_prv_key_sp_label.clone(),
            },
        );
...
pub fn step_in_accum(
    ...
    Arc::new(move |ts| {
        ...
        cred_reqs.in_accum.0.insert(
            ...
            api::InAccumInfo {
                index: a_idx,
                accumulator_public_data_label: acc_pub_data_sp_key.clone(),
                membership_proving_key_label: membership_proving_key_sp_label.clone(),
                accumulator_label: acc_val_sp_key.clone(),
                accumulator_seq_num_label: acc_sn_sp_key.clone(),
            },
        );
