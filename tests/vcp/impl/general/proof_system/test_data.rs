...
lazy_static! {
    pub static ref D_ISSUER_LABEL: IssuerLabel = "DMV".to_string();
    pub static ref S_ISSUER_LABEL: IssuerLabel = "SubscriptionCorp".to_string();
    pub static ref POLICE_AUTHORITY_LABEL: AuthorityLabel = "Police".to_string();
}

lazy_static! {
    pub static ref HOLDER_1: HolderLabel = "Holder1".to_string();
}

lazy_static! {
    pub static ref DEFAULT_ISSUERS: HashMap<IssuerLabel, Vec<ClaimType>> = hashmap!(
...
lazy_static! {
    pub static ref DEFAULT_CREDS: HashMap<CredentialLabel, (IssuerLabel, Vec<DataValue>)> = hashmap!(
