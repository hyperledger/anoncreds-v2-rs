...
use credx::vcp::r#impl::ac2c::signer::*;
use credx::vcp::r#impl::ac2c::to_from_api::*;
use credx::vcp::types::*;
// ------------------------------------------------------------------------------
use crate::vcp::r#impl::general::proof_system::test_data as td;
// ------------------------------------------------------------------------------
use credx::prelude::{CredentialSchema,Issuer};
// ------------------------------------------------------------------------------
...
fn to_from_test() -> Result<(),vcp::Error> {
    ...
    let cred_schema   = CredentialSchema::new(
        ...
        &[],
        &schema_claims).map_err(vcp::Error::CredxError)?;
