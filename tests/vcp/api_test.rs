...
fn spvone() -> &'static str {
    r#"{"contents":{"contents":"{\"signerPublicSchema\":[\"CTText\",\"CTInt\",\"CTInt\",\"CTAccumulatorMember\",\"CTEncryptableText\"],\"signerPublicSetupData\":\"5LDYxXSJd\",\"signerBlindedAttrIdxs\":[0,1]}","tag":"DVText"},"tag":"SPVOne"}"#
}
